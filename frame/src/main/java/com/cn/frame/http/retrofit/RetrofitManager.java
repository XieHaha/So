...
public class RetrofitManager {
    ...
    public static ApiUrlManager getApiUrlManager(Context context) {
        if (apiUrlManager == null) {
            synchronized (ApiUrlManager.class) {
                apiUrlManager = getInstance().initApiUrlManager(context);
            }
        }
    ...
    public static class RetrofitServer {
        ...
        public void init(Context context, String url) {
            baseUrl = url;
            initOkHttp(context, baseUrl);
            initRetrofit(baseUrl);
            initApiUrlManager(context);
        }

        /**
         * 初始化okhttp
         */
        private void initOkHttp(Context context, String baseUrl) {
        ...
        private ApiUrlManager initApiUrlManager(Context context) {
            if (retrofit == null) {
