        ...
        switch (view.getId()) {
            ...
            case R.id.iv_message:
                if (userInfo.getIs_auth() == 1) {
                    ...
                    //设置当前用户信息
                    RongIM.getInstance().setCurrentUserInfo(new UserInfo(userInfo.getRong_cloud_user_id(), bean.getNickname(), Uri.parse(ImageUrlUtil.addTokenToUrl(bean.getHead_portrait()))));
