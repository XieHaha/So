...
public class EaseConversationAdapter extends ArrayAdapter<EMConversation> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.list_itease_layout.setBackgroundResource(R.drawable.ease_mm_listitem_color);
        // get conversation
        ...
        if (!TextUtils.isEmpty(chatId) && chatId.startsWith(BaseData.BASE_DOCTOR_CODE)) {
            ...
            holder.tvRole.setBackgroundResource(R.drawable.corner4_faa05a_bg);
        }
        return convertView;
    }
            ...
            if (prefix == null || prefix.length() == 0) {
                ...
                for (int i = 0; i < count; i++) {
                    ...
                    if (group != null) {
                        ...
                        EaseUser user = EaseUserUtils.getUserInfo(username, new UserInfoCallback() {
                            @Override
