...
public class ImagePreviewView extends AppCompatImageView {
    ...
    private boolean isSmallLoaded = false;
    //
    //------------  加载动画相关 BEGIN  ------------//
    //
    /**
     ...
     * Constructors
     */
    public ImagePreviewView(Context context, Handler handler) {
        this(context, null, handler);
    }

    public ImagePreviewView(Context context, AttributeSet attrs, Handler handler) {
     ...
     * @param img
     */
    public void setZoom(ImagePreviewView img) {
        if (img != null) {
