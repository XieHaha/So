...
public class EaseShowBigImageActivity extends EaseBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (uri != null && new File(uri.getPath()).exists()) {
            ...
            if (bitmap == null) {
                EaseLoadLocalBigImgTask task = new EaseLoadLocalBigImgTask(this, uri.getPath(), image, loadLocalPb,
    ...
    private void clickFinish() {
        finish();
        overridePendingTransition(com.cn.frame.R.anim.anim_fade_in, com.cn.frame.R.anim.anim_fade_out);
    }
}
